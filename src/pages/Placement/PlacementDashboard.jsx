...
export default function PlacementDashboard() {
  ...
  return (
    <Box sx={{ p: 3, maxWidth: 1100, mx: 'auto' }}>
      ...
      <StatGrid>
        <StatTile icon={BusinessIcon} label="Companies" value="—" />
        <StatTile icon={WorkIcon} tint="#2563eb" label="Open positions" value="—" />
        <StatTile icon={PeopleIcon} tint="#059669" label="Applications" value="—" />
      </StatGrid>
