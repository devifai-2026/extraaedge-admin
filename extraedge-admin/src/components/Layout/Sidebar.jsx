...
const menuItems = [
  ...
  { id: 9, label: 'Drip Marketing Campaign', icon: Person4Icon, path: '/bulkudploadlist' },
  { id: 10, label: 'Remarketing', icon: AdjustIcon, path: '/bulkuplosadlist' },
  { id: 11, label: 'Workflow Automation', icon: AutoModeIcon, path: '/bulkuplosadlist' },
  { id: 12, label: 'Connected Accounts', icon: AccountTreeIcon, path: '/bulkupsloadlsist' },
